...
public class SysUserTokenController {
    ...
    public RestResponse getUserAccessByToken(@PathVariable String token) {
        UserAccessDto accessDto = sysUserTokenService.selectAccess(token);
        return RestResponse.success().put("accessDto", accessDto);
    }
}
